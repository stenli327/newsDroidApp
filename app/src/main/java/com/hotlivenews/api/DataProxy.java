...
import com.hotlivenews.util.ObjectUtil;
...
public class DataProxy extends BaseProxyApi {
     ...
     */
    public SourceResponse loadSources(ECategory category, ELanguage language, ECountry country){
        ...
        Call<SourceResponse> call = client.getSources(category.getLabel(), language.getLabel(), country.getLabel());
